...
Foreach ($Seat in 8..1015)
{
    if ($Global:AllSeatIDs -contains $($Seat -1) -and $Global:AllSeatIDs -contains $($Seat +1) -and $Global:AllSeatIDs -notcontains $Seat)
    {
        Write-Output "Seat found: $Seat"
    }
}